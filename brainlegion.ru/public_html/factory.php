...
<html>
  <head>
    ...
    <title>BrainLegion Factory</title>
  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid jumbotron-light m-0 p-5 text-light" id="jumbotron-about">
      <div class="container">
        <h1 class="text-purple">BrainLegion Factory</h1>
        <p class="lead">Анализируем проблему, включаем машину творческого потенциала, собираем  и генерируем лучшие гипотезы и практики, создаем решения, тестируем их и внедряем!</p>
      </div>
    </div>
    ...
    <section class="container-fluid py-5" id="about">
      ...
      <div class="container text-center">
        ...
        <p class="mt-4">Мы предоставляем услуги по выполнению научно-исследовательских работ (НИОКР) для частных и юридических лиц.</p>
        <p class="mt-4">Так же мы выполняем фундаментальные (теоретические) исследования, разрабатываем стратегии и программы развития территорий и муниципальных образований, концепции и обоснования, маркетинговые и социологические исследования, программы модернизации образования, прикладные исследования по заказу органов исполнительной власти, положения, стандарты, научно-исследовательские работы по бюджетно-налоговой тематике, проблемам развития экономики регионов и муниципальных образований, концепции повышения имиджа территорий  и мн. др.</p>
      </div>
    ...
    <!-- Competences Section -->
    <section class="container-fluid py-5" id="competences">
      ...
      <div class="container mt-4 py-2">
        ...
        <div class="row mx-auto mt-4 py-2 justify-content-center">
          ...
          <div class="card-container col-sm-12 col-md-6 col-lg-8 p-0">
            <div class="card card-half-transparent h-100">
              <div class="card-body d-flex flex-column">
                <h4 class="card-title text-center"><b>НИОКРТ «под ключ»</b></h4>
                <ul>  
                    <li>Проведение исследований, разработка технического предложения (аванпроекта)</li>
                        <hr style="width: 100%"  class="mt-0"> 
                    <li>Разработка эскизного проекта; разработка технического проекта</li>
                        <hr style="width: 100%"  class="mt-0">
                    <li>Разработка технического задания на опытно-конструкторские (технологические) работы</li>
                        <hr style="width: 100%"  class="mt-0">
                    <li>Разработка эскизного проекта; разработка технического проекта</li>
                        <hr style="width: 100%"  class="mt-0">
                    <li>Разработка рабочей конструкторской документации на изготовление опытного образца</li>
                        <hr style="width: 100%"  class="mt-0">
                    <li>Отработка документации</li>
                        <hr style="width: 100%" class="mt-0"> 
                    <li>Утверждение рабочей конструкторской документации для организации промышленного (серийного) производства изделий</li>
                        <hr style="width: 100%" class="mt-0"> 
                    <li>Корректировка конструкторской документации по выявленным скрытым недостаткам</li>
                        <hr style="width: 100%" class="mt-0">
                    <li>Разработка эксплуатационной документации</li>
                        <hr style="width: 100%" class="mt-0">
                    <li>Разработка рабочей конструкторской документации на проведение ремонтных работ</li>
                        <hr style="width: 100%" class="mt-0">
                </ul> 
                <a href="#" class="mt-auto text-center"><p class="btn btn-purple-outline" data-ordertype="research">Заказать</p></a>
              </div>
            </div>
          </div>
    ...
    <section class="container-fluid py-5" id="contact">
      ...
      <form method="post" enctype="multipart/form-data" class="d-flex flex-column container pt-4 justify-center align-items-center" id="contact-form">
          ...
          <div class="form-group col-md-6">
            <label for="subject">Тема обращения:</label>
      			<select class="form-control form-purple" id="subjectSelect">
      				<option value="research">НИОКРТ «под ключ»</option>
        ...
        <div class="text-center mt-3">
          <input type="submit" class="btn pointer btn-purple-outline" value="Отправить сообщение">
        ...
        <div class="row justify-content-center text-light py-5">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6" id="footer-contacts">
            ...
            <div id="copyrights">
              ...
              <p>© <a class="link-footer" href="#">Brainlegion.ru</a>, 2018</p>
            </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title align-items-center" id="exampleModalLabel">Заголовок проекта</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <img src="res/img/backs/dark.png" alt="ALT" class="img-fluid">
            <p class="mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae laudantium quidem sit, quam dicta labore, aperiam. Iusto quae, doloribus quaerat ex facere inventore ipsa sed ipsum ad perferendis commodi eos autem tenetur voluptatibus sequi obcaecati eligendi amet blanditiis laudantium veritatis et eius? Nulla at, natus amet, voluptas inventore molestias quae.</p>
          </div>
